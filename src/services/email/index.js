...
async function sendEmail({ emailAccount, to, subject, htmlBody, textBody, fromName, attachments = [], cc }) {
  ...
  const info = await sendSMTP({ credentials: emailAccount.credentials, to, subject, htmlBody, textBody, fromName, attachments, cc });
